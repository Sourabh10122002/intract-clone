            ...
            <div className='nft-tasks'>
                ...
                <div className="cat-outer-img">
                    <div className="cat-inner-img">
                        <img src="https://static.highongrowth.xyz/erc1155-images/65017d014e5f24613adbfd67/1b1912563b964393b0478949efad5ed3.png" alt="cat" />
                    </div>
                    <div className="lockin-lock">
                        <i class="fa-solid fa-lock"></i>
                    </div>
                </div>
                <div className="nft-claim-head">Intract Certified: Learner NFT</div>
                <div className="nft-claim-para">Your crypto black-belt<br />certificate</div>
